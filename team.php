    ...
    <section class="main">
        <div class="main__header">
            ...
            <div class="main__header__text">
                <p class="main__header__text__header">KLUB</p>
        ...
        <div class="main__info">
            <p class="main__info__header">Informacje o klubie</p>
            <p class="main__info__text">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus eius tempora nostrum possimus doloremque autem minima! Consequuntur doloremque modi veritatis.
            </p>
        </div>
        <div class="main__content">
            <div class="main__content__logo">
                <img src="content_img/logoBez.png" class="main__content__logo__first">
                <img src="content_img/TlologaBez.png" class="main__content__logo__back">
            </div>
            <div class="main__content__text l">
                <div class="main__content__text__item">
                    <p class="main__content__text__item__header">Nazwa</p>
                    <p class="main__content__text__item__text">Lorem, ipsum.</p>
                </div>
                <div class="main__content__text__item">
                    <p class="main__content__text__item__header">Nazwa</p>
                    <p class="main__content__text__item__text">Lorem, ipsum.</p>
            ...
            <div class="main__content__text r">
                <div class="main__content__text__item">
                    <p class="main__content__text__item__header">Nazwa</p>
                    <p class="main__content__text__item__text">Lorem, ipsum.</p>
                </div>
        ...
        <div class="main__text">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Maiores corrupti necessitatibus blanditiis, dolore tenetur aperiam odit explicabo magni, sapiente, consectetur voluptate sit accusantium architecto nulla!
        </div>
