...
if (!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true) {
    ...
    if (isset($_POST['edytuj'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            move_uploaded_file($_FILES["img"]["tmp_name"], "../logo_teams/" . $newimg);

            $id = intval($_GET['id']);
            $sql = mysqli_query($connect, "update teams set img='$newimg' where id='$id'");
...
<body>
    ...
    <main class="main">
        <p class="main__header">Zmiana herbu klubu</p>
            ...
            <form name="edytujimg" method="post" enctype="multipart/form-data">
                ...
                ?>
                    ...
                    <div class="main__formContainer__img">
                        <h4 class="main__formContainer__label" style="margin: 20px 0;">Herb klubu</h4>
                        <img src="../logo_teams/<?php echo htmlentities($row['img']); ?>" width="300">

                        <hr style="width: 100%;margin-top: 20px;" />

                        <h4 class="main__formContainer__label">Nowy herb klubu</h4>
                        <input type="file" name="img">

                        <hr style="width: 100%;margin-top: 20px;" />

                        <input for="form" type="submit" value="Aktualizuj" name="edytuj" class="main__formContainer__submit"></input>
                        <a href="druzyny?id=<?php echo htmlentities($postid); ?>">Powrót</a>
                    <?php } ?>
            </form>
