...
<body>
    ...
    <section class="main">
        <div class="main__header">
            ...
            <div class="main__header__containerPC">
                <div class="main__header__containerPC__header">
                    <p class="main__header__containerPC__header__h">SENIORZY</p>
            ...
            <div class="glide">
                <div class="glide__track" data-glide-el="track">
                    <ul class="glide__slides">
                        <?php
                        $sql = mysqli_query($connect, "SELECT * FROM posty WHERE category='Senior' ORDER BY data DESC, id DESC LIMIT 3");
        ...
        <div class="main__container__mecze">
            <div class="main__container__mecze__backlogo">
                <img src="content_img/TlologaBez.png" alt="">
            </div>
            <div class="main__container__mecze__content">
                <div class="main__container__mecze__content__single">
                    <div class="main__container__mecze__content__single__data">
                        <?php
                        $sql = mysqli_query($connect, "SELECT DATE_FORMAT(data, '%Y/%m/%d %H:%i') AS formated_data FROM mecze WHERE data > now() LIMIT 1");

                        while ($row = mysqli_fetch_array($sql)) {
                            $wynik = $row['formated_data'];

                            echo "<p>$wynik</p>";
                        }
                        ?>
                    </div>
                    <div class="main__container__mecze__content__single__container">
                        <div class="main__container__mecze__content__single__container__team">
                            <div class="main__container__mecze__content__single__container__team__container">
                                <?php
                                $sql = mysqli_query($connect, "SELECT * FROM teams WHERE name = 'MKS Iskra Pszczyna'");

                                while ($row = mysqli_fetch_array($sql)) {
                                    $name = $row['name'];
                                    $img = $row['img'];
                                ?>
                                    <img src="logo_teams/<?php echo $img; ?>">
                                    <p class="main__container__mecze__content__single__container__team__container__text"><?php echo $name; ?></p>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="main__container__mecze__content__single__container__vs">
                            <p class="main__container__mecze__content__single__container__vs__text">VS</p>
                            <p class="main__container__mecze__content__single__container__vs__wynik">
                                <?php
                                $sql = mysqli_query($connect, "SELECT wynik FROM mecze WHERE data > now() LIMIT 1");
                        ...
                        <div class="main__container__mecze__content__single__container__team2">
                            <div class="main__container__mecze__content__single__container__team2__container">
                                <?php
                                $sql = mysqli_query($connect, "SELECT mecze.*, teams.img FROM mecze INNER JOIN teams ON mecze.przeciwnik = teams.name WHERE data > now() LIMIT 1");

                                while ($row = mysqli_fetch_array($sql)) {
                                    $nazwa = $row['przeciwnik'];
                                    $img = $row['img'];

                                ?>
                                    <img src="logo_teams/<?php echo $img; ?>">
                                    <p class="main__container__mecze__content__single__container__team2__container__text"><?php echo $nazwa; ?></p>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
        ...
        <div class="mainPC__mecze">
            <img src="content_img/TlologaBez.png" class="mainPC__mecze__backLogo">
            <div class="mainPC__mecze__mecz">
                <div class="mainPC__mecze__mecz__data">
                    <?php
                    $sql = mysqli_query($connect, "SELECT DATE_FORMAT(data, '%Y/%m/%d %H:%i') AS formated_data FROM mecze WHERE data < now() LIMIT 1");
                ...
                <div class="mainPC__mecze__mecz__teams">
                    <div class="mainPC__mecze__mecz__teams__team">
                        <?php
                        $sql = mysqli_query($connect, "SELECT * FROM teams WHERE name = 'MKS Iskra Pszczyna'");
                        ...
                        ?>
                            <img src="logo_teams/<?php echo $img; ?>">
                            <p class="mainPC__mecze__mecz__teams__team__nazwa"><?php echo $name; ?></p>
                        <?php } ?>
                    </div>
                    <div class="mainPC__mecze__mecz__teams__vs">
                        <p class="mainPC__mecze__mecz__teams__vs__text">VS</p>
                        <p class="mainPC__mecze__mecz__teams__vs__wynik">
                            <?php
                            $sql = mysqli_query($connect, "SELECT wynik FROM mecze WHERE data < now() LIMIT 1");
                    ...
                    <div class="mainPC__mecze__mecz__teams__wynik"></div>
                    <div class="mainPC__mecze__mecz__teams__team2">
                        <?php
                        $sql = mysqli_query($connect, "SELECT mecze.*, teams.img FROM mecze INNER JOIN teams ON mecze.przeciwnik = teams.name WHERE data < now() LIMIT 1");
                        ...
                        ?>
                            <img src="logo_teams/<?php echo $img; ?>">
                            <p class="mainPC__mecze__mecz__teams__team2__nazwa"><?php echo $nazwa; ?></p>
                        <?php } ?>
                    </div>
                </div>
            </div>
            <div class="mainPC__mecze__mecz2">
                <div class="mainPC__mecze__mecz2__data">
                    <?php
                    $sql = mysqli_query($connect, "SELECT DATE_FORMAT(data, '%Y/%m/%d %H:%i') AS formated_data FROM mecze WHERE data > now() LIMIT 1");
                ...
                <div class="mainPC__mecze__mecz2__teams">
                    <div class="mainPC__mecze__mecz2__teams__team">
                        <?php
                        $sql = mysqli_query($connect, "SELECT * FROM teams WHERE name = 'MKS Iskra Pszczyna'");
                        ...
                        ?>
                            <img src="logo_teams/<?php echo $img; ?>">
                            <p class="mainPC__mecze__mecz2__teams__team__nazwa"><?php echo $name; ?></p>
                        <?php } ?>
                    </div>
                    <div class="mainPC__mecze__mecz2__teams__vs">
                        <p class="mainPC__mecze__mecz2__teams__vs__text">VS</p>
                        <p class="mainPC__mecze__mecz2__teams__vs__wynik">
                            <?php
                            $sql = mysqli_query($connect, "SELECT wynik FROM mecze WHERE data > now() LIMIT 1");
                    ...
                    <div class="mainPC__mecze__mecz2__teams__wynik"></div>
                    <div class="mainPC__mecze__mecz2__teams__team2">
                        <?php
                        $sql = mysqli_query($connect, "SELECT mecze.*, teams.img FROM mecze INNER JOIN teams ON mecze.przeciwnik = teams.name WHERE data > now() LIMIT 1");
                        ...
                        ?>
                            <img src="logo_teams/<?php echo $img; ?>">
                            <p class="mainPC__mecze__mecz2__teams__team2__nazwa"><?php echo $nazwa; ?></p>
                        <?php } ?>
                    </div>
                </div>
            </div>
        </div>
        <div class="main__container__tabela">
            <div class="main__container__tabela__header">
                <?php
            ...
            <table class="main__container__tabela__table" cellspacing="0">
                <tr>
                    <td style='width: 25px;text-align: center;'>P</td>
                    <td colspan="2">Drużyna</td>
                    <td style='width: 25px;text-align: center;'>W</td>
                    <td style='width: 25px;text-align: center;'>P</td>
                    <td style='width: 25px;text-align: center;'>R</td>
                    <td style="width: 50px;text-align: center;" class="main__container__tabela__table__last">PKT</td>
                </tr>
                <?php
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    if ($pozycja % 2 == 0) {
                        ...
                        <td style='font-weight: 700;'>$nazwa</td>
                        <td style='text-align: center;'>$w</td>
                        <td style='text-align: center;'>$p</td>
                        <td style='text-align: center;'>$r</td>
                        <td style='font-weight: 700;text-align: center;'>$pkt</td>
                    </tr>";
                    } else {
                        echo "<tr>
                            <td style='text-align: center;'>$pozycja</td>
            ...
            <table class="main__container__tabela__table2" cellspacing="0">
                <tr>
                    <td></td>
                </tr>
                <?php
