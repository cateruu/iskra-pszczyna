...
<body>
    ...
    <section class="main">
        ...
        <div class="main__zdjecia">
            <div class="z">
                <img src="content_img/stadion3.jpg" alt="">
            </div>
            <div class="main__zdjecia__item">
                <img src="content_img/stadion1.jpg" alt="">
            </div>
            <div class="main__zdjecia__item">
                <img src="content_img/stadion2.jpg" alt="">
            </div>
        </div>
        <div class="main__info">
            <p class="main__info__header">O stadionie</p>
        ...
        <div class="main__zdjeciaT">
            <div class="z">
                <img src="content_img/trenign1.jpg" alt="">
            </div>
            <div class="main__zdjecia__item">
                <img src="content_img/trenign2.jpg" alt="">
            </div>
            <div class="main__zdjecia__item">
                <img src="content_img/trening3.jpg" alt="">
            </div>
        </div>
        <div class="main__baza">
            <p class="main__info__header">Baza treningowa</p>
            <p class="main__info__text">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus eius tempora nostrum possimus doloremque autem minima! Consequuntur doloremque modi veritatis.
            </p>
        </div>
